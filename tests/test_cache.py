...
-v stands for verbose, which provides more detailed output about which tests are running and 
their results. This is helpful for debugging and understanding the test flow.
