...
-v stands for verbose, which provides more detailed output about which tests are running 
and their results. This is helpful for debugging and understanding the test flow.
...
'''
This test suite focuses on the security components of the application, specifically the 
InputSanitizer, PIIDetector, and OutputValidator classes. These tests are designed to run 
without making any calls to external LLMs, ensuring that they are fast, free, and deterministic.
'''
